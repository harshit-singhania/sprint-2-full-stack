...
public class CarController {
    ...
    @PostMapping
    public CarListingResponse add(@RequestHeader("X-Session-Token") String token,
                                  @Valid @RequestBody CarRequest request) {
        return carService.addCar(token, request);
    }

    @PutMapping("/{carId}")
    public Car update(@RequestHeader("X-Session-Token") String token,
    ...
    @DeleteMapping("/{carId}")
    public ApiMessage delete(@RequestHeader("X-Session-Token") String token,
                             @PathVariable @Positive Long carId) {
    ...
    @GetMapping("/{carId}")
    public Car details(@RequestHeader("X-Session-Token") String token,
                       @PathVariable @Positive Long carId) {
