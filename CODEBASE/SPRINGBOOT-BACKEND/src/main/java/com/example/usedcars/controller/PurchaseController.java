...
public class PurchaseController {
    ...
    public Object purchase(@RequestHeader("X-Session-Token") String token,
     ...
     * Accessible by the buyer, the seller, or an admin.
     */
    @GetMapping("/orders/{orderId}/receipt")
    public ReceiptResponse receipt(@RequestHeader("X-Session-Token") String token,
    ...
    public PurchaseOrder approve(@RequestHeader("X-Session-Token") String token,
                                 @PathVariable @Positive Long orderId) {
        return purchaseService.approve(token, orderId);
    }

    @PostMapping({"/seller/orders/{orderId}/reject", "/user/sales/{orderId}/reject"})
    public PurchaseOrder reject(@RequestHeader("X-Session-Token") String token,
                                @PathVariable @Positive Long orderId) {
