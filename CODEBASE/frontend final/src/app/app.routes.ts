...
export const routes: Routes = [
  ...
  // Admin shell routes
  {
    ...
    children: [
      ...
      {
        path: 'graphs',
        loadComponent: () => import('./features/admin/graphs/admin-graphs.component').then(m => m.AdminGraphsComponent)
      },
      {
        path: 'orders',
        loadComponent: () => import('./features/admin/all-orders/admin-all-orders.component').then(m => m.AdminAllOrdersComponent)
      }
    ]
  },
