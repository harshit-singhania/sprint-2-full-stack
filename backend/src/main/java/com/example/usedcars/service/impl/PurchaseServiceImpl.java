...
public class PurchaseServiceImpl implements PurchaseService {
    ...
    public List<PurchaseOrder> myOrders(String token) {
        ...
        if (user.getRole() == Role.ADMIN) {
            ...
            orders.forEach(this::initializeOrderGraph);
            return orders;
        }
    ...
    public List<PurchaseOrder> pendingForSeller(String token) {
        ...
        List<PurchaseOrder> orders = orderRepository.findBySellerAndStatus(seller, OrderStatus.PENDING_SELLER_APPROVAL);
        orders.forEach(this::initializeOrderGraph);
        return orders;
    }
    ...
    private void initializeOrderGraph(PurchaseOrder order) {
        ...
        if (order.getCar() != null) {
            ...
            if (order.getCar().getSeller() != null) {
                order.getCar().getSeller().getUsername();
            }
        }
